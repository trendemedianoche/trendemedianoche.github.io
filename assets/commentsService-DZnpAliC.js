import{s as t}from"./index-CZsV6orn.js";async function a(o){const{data:e,error:r}=await t.from("blog_comments").select("*").eq("post_id",o).order("created_at",{ascending:!0});return r?[]:e||[]}async function s(){const{data:o,error:e}=await t.from("blog_comments").select(`
      *,
      blog_posts (
        title
      )
